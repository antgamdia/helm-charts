...
NOTE: If a Trento server is already installed on the host, the script updates it.
...
The `charts/trento-server` directory contains the Helm chart for installing Trento Server in a Kubernetes cluster.
...
NOTE: Replace `trento.example.com` with a valid hostname that resolves to the Trento server.
...
For advanced configuration, review the complete values references:

* xref:trento-server-values.adoc[Main chart values reference]
* `charts/trento-server/charts/trento-web/README.md`
* `charts/trento-server/charts/trento-wanda/README.md`
* `charts/trento-server/charts/trento-mcp-server/README.md`
* `charts/trento-server/charts/rabbitmq/README.md`
