...
| image.tag | string | `"3.12.6-management-alpine"` |  |
...
| ldap.tls.certificatesMountPath | string | `"/etc/rabbitmq/ldap/certs"` |  |
...
| loadDefinition.file | string | `"/etc/rabbitmq/definitions/load_definition.json"` |  |
| logs | string | `"-"` |  |
...
| persistence.mountPath | string | `"/var/lib/rabbitmq"` |  |
| persistence.selector | object | `{}` |  |
| persistence.size | string | `"8Gi"` |  |
| persistence.storageClass | string | `""` |  |
| persistence.subPath | string | `""` |  |
| plugins[0] | string | `"rabbitmq_management"` |  |
| plugins[1] | string | `"rabbitmq_peer_discovery_k8s"` |  |
| plugins[2] | string | `"rabbitmq_auth_backend_ldap"` |  |
...
| volumePermissions.image.repository | string | `"alpine"` |  |
| volumePermissions.image.tag | string | `"3.19"` |  |
